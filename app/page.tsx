      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 pb-16">
        ...
        <motion.div style={{ y: heroY, opacity: heroOpacity }} className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
            className="inline-flex items-center gap-2 px-5 py-2 rounded-full mb-8 text-xs tracking-widest uppercase"
            style={{ background: `${gold}12`, border: `1px solid ${gold}30`, color: gold }}>
            <Star size={10} color={gold}/> Platform Undangan Digital Premium <Star size={10} color={gold}/>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1 }}
            className="flex justify-center gap-12 mt-16 pt-10 pb-4 border-t" style={{ borderColor: `${gold}15` }}>
            {[
              ...
              <div key={String(label)} className="text-center">
                <p className="font-serif-elegant text-3xl" style={{ color: gold }}>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {steps.map((s, i) => (
              <Reveal key={s.num} delay={i * 0.1} className="text-center relative">
                {i < steps.length - 1 && (
                  <div className="hidden md:block absolute top-7 left-[55%] w-full h-px"
                    style={{ background: `linear-gradient(to right, ${gold}40, transparent)` }}/>
                )}
                <div className="w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-4 font-serif-elegant text-xl"
