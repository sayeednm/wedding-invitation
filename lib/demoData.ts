...
export function getDemoInvitation(templateId: string, withPhotos = true): Invitation {
  return {
    ...
    gift_recipient_name: 'Rizky & Amara',
    gift_recipient_phone: '+6281234567890',
    gift_address: 'Jl. Kebahagiaan No. 21, Kebayoran Baru, Jakarta Selatan 12110',
    cover_type: 'photo',
    silhouette_variant: 'standing',
    photo_frame: 'oval',
    dresscode_enabled: true,
    photo_decoration: true,
